...
public class TestController {
	 ...
	 * And if the correct balance is displayed after the purchase.
	 * @throws DisabledException
	 */
	@Test
	...
	/**
	 * We are also unloading all of the pop and adding only a single pop can 
	 * into the machine.
	 * Than we are testing if the PCRListener announces when the rack is empty
	 * after purchasing the last pop.
	 * @throws DisabledException
	 * @throws CapacityExceededException
	 */
	@Test
	...
	/**
	 * Testing if the machine doesn't dispense pop when the popCanRack is disabled
	 ...
	 * has been enabled and we can still Add pop afterwards
	 * @throws DisabledException
	 * @throws CapacityExceededException
	 */
	@Test
	...
	/**
	 * Testing if the machine doesn't dispense pop when the selection button
	 * is disabled and also leaves the balance unchanged.
	 * @throws DisabledException
	 * @throws CapacityExceededException
	 */
	@Test
	...
	/**
	 * Testing if the machine dispense's pop when the selectionButtons
	 * are enabled
	 * @throws DisabledException
	 * @throws CapacityExceededException
	 */
	...
	public void testEnabledButtons() throws DisabledException, CapacityExceededException {
		...
		pushButton(0);
		assertEquals("Can Removed" ,controller.getLastMessage());
	}
